...
export function ReelPlayer({ reel, isActive, isMuted, toggleMute }: ReelPlayerProps) {
    ...
    return (
        <div className="h-screen w-full relative flex items-center justify-center bg-[#0a0a0a] select-none sm:py-6">
            ...
            <div className="relative w-full h-full sm:max-w-[420px] md:max-w-[480px] lg:max-w-[600px] sm:rounded-[2rem] overflow-hidden bg-black flex items-center justify-center z-10 sm:ring-1 sm:ring-white/10 shadow-2xl">
