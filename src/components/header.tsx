...
import { Bell, Menu, LogOut, Moon, User as UserIcon, Settings, Search } from "lucide-react"
...
{/* 
          ...
          <div className="relative">
            ...
            {mobileMenuOpen && (
              <div className="absolute right-0 top-full mt-2 w-64 z-50 md:hidden animate-in fade-in zoom-in duration-200">
                <MenuContent />
              </div>
            )}
          </div>
