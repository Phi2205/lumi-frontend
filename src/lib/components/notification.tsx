    ...
    >
      ...
      >
        ...
        <button
          ...
          className="absolute top-4 right-4 w-7 h-7 rounded-lg bg-white/10 border border-white/15 flex items-center justify-center cursor-pointer transition-all duration-300 ease z-10 hover:bg-white/20"
        >
