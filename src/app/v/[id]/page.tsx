  ...
  return (
    <HomeLayout>
      ...
      <div className="fixed inset-0 z-[100]">
        ...
        <button
          onClick={handleClose}
          className="fixed top-20 right-6 z-[110] w-10 h-10 rounded-full bg-white/10 border border-white/20 flex items-center justify-center text-white/80 hover:bg-white/20 hover:text-white transition-all cursor-pointer backdrop-blur-xl hover:scale-105 active:scale-95"
          aria-label="Đóng"
        >
          <X size={20} />
        </button>
        ...
        >
          ...
          >
            <div
              className="w-full max-w-2xl relative z-[1]"
